...
class ProfileViewController: UIViewController {
    ...
    let nameLabel = UILabel(text: "Anna Tkach", font: .systemFont(ofSize: 20, weight: .light))
    let aboutMeLabel = UILabel(text: "You have opportunityto to chat with the best girl in the world!", font: .systemFont(ofSize: 16, weight: .light))
